...
def fetch_channel_metadata(youtube, channel_ids: List[str], quota_tracker=None) -> List[Dict]:
    """
    ...
    for i in range(0, len(channel_ids), batch_size):
        ...
        try:
            ...
            logger.info(f"Fetched metadata for {len(channels)} channels in batch {i//batch_size + 1}")
